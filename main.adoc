...
include::modules/k8s-best-practices-networking-connectivity.adoc[leveloffset=+3]
...
include::modules/k8s-best-practices-lifecycle-management.adoc[leveloffset=+5]
